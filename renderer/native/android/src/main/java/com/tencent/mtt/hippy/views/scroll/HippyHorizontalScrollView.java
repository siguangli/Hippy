...
public class HippyHorizontalScrollView extends HorizontalScrollView implements HippyViewBase, HippyScrollView,
        ScrollChecker.IScrollCheck, ClipChildrenView, HippyNestedScrollTarget, NestedScrollingParent2 {
  ...
  private boolean mHasUnsentScrollEvent;
    ...
    private final HashMap<Integer, Integer> scrollOffsetForReuse = new HashMap<>();
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (mDoneFlinging) {
                    ...
                    HippyScrollViewEventHelper.emitScrollEvent(HippyHorizontalScrollView.this,
